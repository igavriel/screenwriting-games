...
window.GAME_CATALOG = [
  ...
  },
  {
    ...
    date: '06/2026',
    externalLinks: [
      { label: 'Ren\'Py', href: 'https://www.renpy.org/' },
    ...
    gallery: [
      ...
      { label: 'Room Normal background', src: './renpy/one_more_moment/game/images/bg_vn_room_normal.jpeg' },
      { label: 'Room Glitch background', src: './renpy/one_more_moment/game/images/bg_vn_room_glitch.jpeg' },
      { label: 'Anxious Fake OK', src: './renpy/one_more_moment/game/images/character anxious_fake_ok.png' },
      { label: 'Blank Screen Honest', src: './renpy/one_more_moment/game/images/character blank_screen_honest.png' },
      { label: 'Default Fake Smile', src: './renpy/one_more_moment/game/images/character default_fake_smile.png' },
      { label: 'Fake Dramatic Heroine', src: './renpy/one_more_moment/game/images/character fake_dramatic_heroine.png' },
      { label: 'Final Real', src: './renpy/one_more_moment/game/images/character final_real.png' },
      { label: 'Sarcastic Really', src: './renpy/one_more_moment/game/images/character sarcastic_really.png' },
      { label: 'Stop Narrator', src: './renpy/one_more_moment/game/images/character stop_narrator.png' },
      { label: 'Vulnerable Honest', src: './renpy/one_more_moment/game/images/character vulnerable_honest.png' },
      { label: 'With Shadow Truth', src: './renpy/one_more_moment/game/images/character with_shadow_truth.png' },
    ],
  },
];
